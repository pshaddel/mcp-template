...
const weatherToolArgValidator = {
    ...
    start_date: z.string().describe('Start date for the weather data in YYYY-MM-DD format, e.g., 2025-07-25'),
    end_date: z.string().describe('End date for the weather data in YYYY-MM-DD format, e.g., 2025-07-25'),
    timezone: z.enum(['Europe/London', 'America/New_York', 'Asia/Tokyo']).default('Europe/London').describe('Timezone for the weather data, e.g., Europe/London, America/New_York, Asia/Tokyo')
};
...
export const weatherTool: Tool = {
    tool_name: 'weather',
    description: 'Gets Weather Data from Open Meteo API by passing required parameters like latitude, longitude, start_date, end_date, and timezone.',
